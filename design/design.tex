...
\fbox{\begin{minipage}{6.72in}
	...
	% Text Node
	\draw    (288.01,28) -- (378.01,28) -- (378.01,95) -- (288.01,95) -- cycle  ;
	\draw (333.01,32) node [anchor=north] [inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{58.49pt}\setlength\topsep{0pt}
	\begin{center}
	Transaction \\\underline{tId}\\fee
	\end{center}
